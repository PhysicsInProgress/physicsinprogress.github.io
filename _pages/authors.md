...
Information on formatting can be found at the [author guidelines page](https://journals.aps.org/prl/authors#techformat) for *Physical Review Letters*. Especially note that math should be properly punctuated and that vectors are denoted with mathematical boldface.
